 ...
 */
func (a ListApi) ListGet(apiKey string) (*InlineResponse2007, *APIResponse, error) {
 ...
 */
func (a ListApi) ListPost(apiKey string, body ListAddUpdate) (*InlineResponse2008, *APIResponse, error) {
